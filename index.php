                ...
                <tbody>
                    ...
                    if(mysqli_num_rows($res) > 0):
                        while($row = mysqli_fetch_assoc($res)):
                            ...
                            $cls = "bg-secondary"; // default
                            if($status == 'available') $cls = "bg-success";
                            if($status == 'borrowed') $cls = "bg-warning text-dark";
                            if($status == 'maintenance') $cls = "bg-danger";
                    ?>
                    <tr>
                        <td>#<?= $row['id'] ?></td>
                        ...
                        <td><?= !empty($row['borrower']) && $row['borrower'] != '-' ? $row['borrower'] : '<span class="text-muted small">None</span>' ?></td>
